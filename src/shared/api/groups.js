...
export const groupsApi = {
  ...
  create(payload) {
    return apiRequest('/api/groups', { method: 'POST', body: JSON.stringify(payload) })
  },
  update(groupId, payload) {
    return apiRequest(`/api/groups/${groupId}`, { method: 'PATCH', body: JSON.stringify(payload) })
  },
  join(groupId) {
    return apiRequest(`/api/groups/${groupId}/join`, { method: 'POST' })
  },
  leave(groupId) {
    return apiRequest(`/api/groups/${groupId}/join`, { method: 'DELETE' })
  },
  members(groupId) {
  ...
  approve(groupId, memberId) {
    return apiRequest(`/api/groups/${groupId}/members/${memberId}/approve`, { method: 'PATCH' })
  },
