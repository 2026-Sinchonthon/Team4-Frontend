...
const navItems=[{label:'홈',href:'/home',icon:<img src={homeIcon} alt=""/>,isActive:true},{label:'모임 피드',href:'/groups',icon:<img src={groupFeedIcon} alt=""/>},{label:'네트워킹',href:'/networking',icon:<img src={networkingIcon} alt=""/>},{label:'마이 페이지',href:'/mypage',icon:<img src={mypageIcon} alt=""/>}]
...
function App(){
  ...
  if (path === '/' || path === '/login' || path === '/login/email' || path === '/signup' || path === '/onboarding') {
    return <AuthPage />
  }
